...
const PRESET_HELP = {
  human_max: {
    ...
    operations: [
      ...
      "legit_max_cats: Unlocks cats available for the current game version, applies legal max base/plus, unlocks true+4th forms where valid, maxes talents.",
      "claim_user_rank_rewards: Marks all unlocked user-rank rewards as already claimed.",
  ...
  full_legit_max: {
    ...
    operations: [
      ...
      "special_skills_max + cat_base_cannons_max + legit_max_cats + claim_user_rank_rewards + max_gamatoto: Applies max progression on available units/base/rank rewards/gamatoto.",
